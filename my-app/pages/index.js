...
export default function Home() {
   ...
   * the address of the connectes address
  */
   ...
   *  needing to make a digital signature to authorize the transactio being sent. Metamask exposes a Signer API to allow your website to 
